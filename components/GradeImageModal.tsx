                        ...
                        <table className="w-full text-sm border-collapse">
                            <thead>
                                <tr className="border-b border-slate-300">
                                    ...
                                    {viewMode !== 'final' && partialEvaluations.map(ev => <th key={ev.id} className="p-2 text-center font-semibold text-slate-600 text-xs">{ev.name} <br/><span className="font-normal opacity-70">({ev.maxScore})</span></th>)}
